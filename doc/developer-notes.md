...
AllCoinGuru Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as AllCoinGuru Core, where everyone uses
...
pay attention to for reviewers of AllCoinGuru Core code.

General AllCoinGuru Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: AllCoinGuru Core uses tinyformat, which is type safe. Leave them out to avoid confusion
