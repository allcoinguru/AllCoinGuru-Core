...
This mechanism has been integrated into Bitcore-Node-AllCoinGuru which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/allcoinguruproject/insight-api-allcoinguru#web-socket-api](https://github.com/allcoinguruproject/insight-api-allcoinguru#web-socket-api)
* API: [https://github.com/allcoinguruproject/insight-api-allcoinguru#instantsend-transactions](https://github.com/allcoinguruproject/insight-api-allcoinguru#instantsend-transactions)
...
By default, the AllCoinGuru Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the AllCoinGuru Core daemon:
