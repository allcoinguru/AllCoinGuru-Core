...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("AllCoinGuru Core allcoinguru-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  allcoinguru-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded allcoinguru transaction") + "\n" +
              "  allcoinguru-tx [options] -create [commands]   " + _("Create hex-encoded allcoinguru transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded allcoinguru transaction
