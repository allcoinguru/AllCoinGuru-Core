...
2. run allcoingurud with -printalert or -sendalert like this:
   /path/to/allcoingurud -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.allcoinguru.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/AllCoinGuru Core:0.12.0.58/"));
