    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("CGUR-light"), QVariant("light"));
    ui->theme->addItem(QString("CGUR-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("CGUR-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("CGUR-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("CGUR-traditional"), QVariant("trad"));
