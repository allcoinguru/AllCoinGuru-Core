    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("AllCoinGuru Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About AllCoinGuru Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  allcoinguru-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the AllCoinGuru in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
PrivateSend uses an innovative process to mix your inputs with the inputs of two other allcoinguru, without having your coins ever leave your wallet. \
...
These denominations are 0.01 CGUR, 0.1 CGUR, 1 CGUR and 10 CGUR -- sort of like the paper money you use every day.</li> \
...
<li>When two other allcoinguru send similar messages, indicating that they wish to mix the same denomination, a mixing session begins. \
...
For more info see <a href=\"https://AllCoinGuruDev.atlassian.net/wiki/display/DOC/PrivateSend\">https://AllCoinGuruDev.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("AllCoinGuru Core is shutting down...") + "<br /><br />" +
