    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("AllCoinGuru Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a AllCoinGuru address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and allcoinguru: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About AllCoinGuru Core"), this);
    aboutAction->setStatusTip(tr("Show information about AllCoinGuru Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for AllCoinGuru Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your AllCoinGuru addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified AllCoinGuru addresses"));
    ...
    openAction->setStatusTip(tr("Open a allcoinguru: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the AllCoinGuru Core help message to get a list with possible AllCoinGuru Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("AllCoinGuru Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to AllCoinGuru network", "", count));
    } else {
...
{
    QString strTitle = tr("AllCoinGuru Core"); // default title
    ...
    // Append title to "AllCoinGuru Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
