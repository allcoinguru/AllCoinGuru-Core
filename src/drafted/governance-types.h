...
enum GovernanceObjectType {
    ...
    // -------------------------------
    // AllCoinGuruNetwork - is the root node
    AllCoinGuruNetwork = 1000,
    AllCoinGuruNetworkVariable = 1001,
    Category = 1002,
    ...
    //   --  allcoinguru that operate DAOs will own companies which can own things legally
    Group = 2000,
    User = 2001,
    Company = 2002,
