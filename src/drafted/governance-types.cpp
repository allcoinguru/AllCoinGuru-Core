...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "AllCoinGuruNetwork") type = AllCoinGuruNetwork;
    if(strType == "AllCoinGuruNetworkVariable") type = AllCoinGuruNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == AllCoinGuruNetwork) s = "AllCoinGuruNetwork";
    if(type == AllCoinGuruNetworkVariable) s = "AllCoinGuruNetworkVariable";
