 ...
 *
 *   // network
 *   CAllCoinGuruNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.allcoinguru.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CAllCoinGuruNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CAllCoinGuruNetwork(UniValue objIn)
    {
...
// // can be under: AllCoinGuruNetwork
// //   -- signature requirements : Key1(User)
// class CAllCoinGuruNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == AllCoinGuruNetwork);
//     // }
