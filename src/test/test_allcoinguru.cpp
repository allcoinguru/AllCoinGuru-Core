...
#define BOOST_TEST_MODULE AllCoinGuru Test Suite

#include "test_allcoinguru.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_allcoinguru_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
